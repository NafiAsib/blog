...
- [MTEB: Massive Text Embedding Benchmark - Embedding Leaderboard](https://huggingface.co/spaces/mteb/leaderboard)
- [OpenRouter - Mostly all LLM key from a single platform (Offers a lot of free api request on different models, Has ranking based on different criteria)](https://openrouter.ai/)
